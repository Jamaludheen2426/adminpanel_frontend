  ...
  useEffect(() => {
    if (settings) {
      ...
      setValues({
        ...
        coming_soon_html:
          settingsMap.coming_soon_html || getDefaultComingSoonHTML(),
      });
    }
  }, [settings]);
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Set the text direction for the interface
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2 max-w-md">
              ...
              <Select
                ...
                onValueChange={(val) =>
                  setValues({ ...values, font_direction: val })
                }
              >
                <SelectTrigger>
                  <SelectValue />
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enable this to show a &quot;Coming Soon&quot; page to visitors on
              the main site
            </CardDescription>
          </CardHeader>
            ...
            <div className="flex items-center justify-between max-w-md">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  When enabled, visitors will see a coming soon page instead of
                  the main site
                </p>
              </div>
              <Switch
                ...
                onCheckedChange={(checked) =>
                  setValues({
                    ...values,
                    coming_soon_enabled: checked ? "true" : "false",
                  })
                }
              />
            </div>
              ...
              <div className="space-y-4 pt-4 border-t">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Customize the HTML content that will be displayed on the
                    coming soon page
                  </p>
                </div>
                  ...
                  <TabsContent value="editor" className="space-y-2">
                    <Textarea
                      ...
                      onChange={(e) =>
                        setValues({
                          ...values,
                          coming_soon_html: e.target.value,
                        })
                      }
                      className="min-h-[400px] font-mono text-sm"
                    />
                    <p className="text-xs text-muted-foreground">
                      You can use HTML, CSS (inline or in style tags), and basic
                      styling
                    </p>
                  </TabsContent>
                    ...
                    <div className="border rounded-lg p-6 min-h-[400px] bg-background">
                      <div
                        ...
                        dangerouslySetInnerHTML={{
                          __html: values.coming_soon_html,
                        }}
                      />
                    </div>
                    <p className="text-xs text-muted-foreground">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    onClick={() =>
                      setValues({
                        ...values,
                        coming_soon_html: getDefaultComingSoonHTML(),
                      })
                    }
                  >
                    Reset to Default
